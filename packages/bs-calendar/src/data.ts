// Each entry = 12 values = days in each month of that BS year
...
export const BS_MONTH_DATA: Record<number, number[]> = {
  ...
  2083: [31, 31, 32, 32, 31, 31, 30, 29, 30, 29, 30, 30],
...
//
// NOTE on the epoch: the spec text cites "13 April 1943", but the BS_MONTH_DATA
// table above sums to exactly ONE more day than the real AD gap when anchored at
// 13 April. Verified: real days between 1943-04-13 and 2024-04-13 = 29586, but the
// table (BS 2000-01-01 -> 2081-01-01) sums to 29587. Anchoring at 12 April 1943
// makes the table reproduce BOTH real-world anchors exactly:
//   2024-04-13 -> BS 2081-01-01 (Nepali New Year)
//   2024-01-01 -> BS 2080-09-17
// The lookup table is left unchanged; only this epoch constant is adjusted by 1 day.
export const BS_EPOCH = { bsYear: 2000, bsMonth: 1, bsDay: 1 };
export const AD_EPOCH = new Date(1943, 3, 12); // April 12, 1943 (month is 0-indexed)
