...
export class StorageService implements OnModuleInit {
  ...
  /**
   * BILL-8: server-generated bytes (a rendered PDF) rather than a client
   * upload — no kind-policy check, since there is no client-declared
   * size/content-type to validate against. Caller owns the key shape.
   */
