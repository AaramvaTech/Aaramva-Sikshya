...
function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-4 flex h-96 w-80 flex-col rounded-2xl border border-gray-200 bg-white shadow-theme-lg dark:border-gray-800 dark:bg-gray-900 z-99999">
...
function UserMenu() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-4 w-60 flex flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-900 z-99999">
          <div className="mb-3">
